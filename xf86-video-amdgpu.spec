...
#
# Source0 file verified with key 0x9B4EE4F98474DE40 (alexdeucher@gmail.com)
#
Name     : xf86-video-amdgpu
Version  : 21.0.0
Release  : 54
URL      : https://www.x.org/releases/individual/driver/xf86-video-amdgpu-21.0.0.tar.gz
Source0  : https://www.x.org/releases/individual/driver/xf86-video-amdgpu-21.0.0.tar.gz
Source1  : https://www.x.org/releases/individual/driver/xf86-video-amdgpu-21.0.0.tar.gz.sig
...
%prep
%setup -q -n xf86-video-amdgpu-21.0.0
cd %{_builddir}/xf86-video-amdgpu-21.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627668909
...
cp %{_builddir}/xf86-video-amdgpu-21.0.0/COPYING %{buildroot}/usr/share/package-licenses/xf86-video-amdgpu/a297a2b3d9f367ccee795c8a4260d8c7f40ab78f
%make_install
